  ...
  return knex('recipes').del()
    .then(function () {
      return knex('recipes').insert([
        ...
        {recipe_id: 3, category_id: 2202, recipe_name: 'Crack Pie', chef_name: 'Christina Tosi', recipe_image_url: 'http://milkbarstore.com/main/wp-content/uploads/2015/04/Staged_Pie_Crack_High_04.jpg', recipe_ingredients: 'Crack and pie', recipe_method: 'It is long.', recipe_comments: "You will quickly learn where this pie got its name." },
        ...
        { recipe_id: 8, category_id: 2202, recipe_name: 'Raspberry Pie', chef_name: "Mrs. Pie Lady", recipe_image_url: "http://clv.h-cdn.co/assets/15/12/640x640/square-1426610944-138638408.jpg", recipe_ingredients: "Pie", recipe_method: "Make pie", recipe_comments: "it's pie" },
        ...
        {recipe_id: 21, category_id: 2201, recipe_name: 'Funfetti Cake', chef_name: 'Cake', recipe_image_url: 'http://theglitterguide.com/wp-content/uploads/2016/02/static1.squarespace-e1455656673200.jpg', recipe_ingredients: 'Cake', recipe_method:
        'Directions: '},
